<template>
  <div>
    ...
    <div class="publish-content">
      <div class="publish-date">{{ dataData[active].date }}</div>
      <div class="publish-item" v-for="(subItem, subIdx) in dataData[active].data" :key="subIdx" @click="linkFun(dataData[active].url, subItem.id)">
