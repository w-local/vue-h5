<template>
  <div>
    ...
    <div class="form-wrap">
      ...
      <van-field v-model="value1" label-width="5rem" label="标题" input-align="right" placeholder="请输入" />
      <van-field v-model="value1" label-width="5rem" label="电话" input-align="right" placeholder="请输入" />
      <van-field v-model="value1" rows="2" :border="false" type="textarea" maxlength="200" placeholder="请输入～" show-word-limit />
      <div class="form-item">
